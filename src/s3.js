...
// export const ROOT_URL = 'https://cs52-abhi-blog.herokuapp.com/api';
export const ROOT_URL = 'https://s3-ec.herokuapp.com/api';
...
function uploadFileToS3(signedRequest, file, url) {
  return new Promise((fulfill, reject) => {
    axios.put(signedRequest, file, { headers: { 'Content-Type': file.type } })
      .then((response) => {
        console.log(url);
